...
import org.springrain.frame.service.BaseSlaveServiceImpl;
import org.springrain.frame.util.Finder;

@Service("baseSlaveService")
public class BaseSpringrainSlaveServiceImpl extends BaseSlaveServiceImpl implements
		IBaseSpringrainSlaveService {

	@Resource
	IBaseSlaveJdbcDao baseSlaveDao;

	public BaseSpringrainSlaveServiceImpl() {
	}

	@Override
	public IBaseSlaveJdbcDao getBaseDao() {
		return baseSlaveDao;
	}
