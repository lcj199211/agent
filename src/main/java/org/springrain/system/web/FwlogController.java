...
//	public @ResponseBody
//	ReturnDatas saveorupdate(Model model,FwlogHistory2017 fwlogHistory2017,HttpServletRequest request,HttpServletResponse response) throws Exception{
//		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
//		returnObject.setMessage(MessageUtils.UPDATE_SUCCESS);
//		try {
//		
//			java.lang.String id =fwlogHistory2017.getId();
//			if(StringUtils.isBlank(id)){
//			  fwlogHistory2017.setId(null);
//			}
//		
//			fwlogHistory2017Service.saveorupdate(fwlogHistory2017);
//			
//		} catch (Exception e) {
