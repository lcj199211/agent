...
public class User  extends BaseEntity {
	...
	private java.lang.String cpuandmac;
	
	@WhereSQL(sql="cpuandmac=:User_cpuandmac")
	public java.lang.String getCpuandmac() {
		return cpuandmac;
	}

	public void setCpuandmac(java.lang.String cpuandmac) {
		this.cpuandmac = cpuandmac;
	}
	@WhereSQL(sql="id2=:User_id2")
	...
	//get and set
	    ...
	    public void setLogintime(java.util.Date value) {
	      ...
	      @WhereSQL(sql="logintime=:User_logintime")
		...
		public String toString() {
			...
			.append("登录时间[").append(getLogintime()).append("],")
			.toString();
		}
		...
		public void setManagerOrgs(List<UserOrg> managerOrgs) {
		 ...
		 @WhereSQL(sql="agentid=:User_agentid")
		...
		@WhereSQL(sql="isagent=:User_isagent")
