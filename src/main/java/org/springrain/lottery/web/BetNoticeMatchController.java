 ...
 */
@Controller
@RequestMapping(value="/betnoticematch")
public class BetNoticeMatchController  extends BaseController {
	@Resource
	private IBetNoticeService betNoticeService;
	@Resource
	private IBetAgentService betAgentService;
	
	private String listurl="/lottery/betnotice/match/betnoticeList";
	...
	public String look(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception {
		...
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
		return "/lottery/betnotice/match/betnoticeLook";
	}
	...
	public String updatepre(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception{
			...
			return "/lottery/betnotice/match/betnoticeCru";
	}
