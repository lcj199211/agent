 ...
 */
@Controller
@RequestMapping(value="/betagentreportformjc")
public class BetAgentreportformJcController  extends BaseController {
	@Resource
	...
	private String listurl="/lottery/betreportform/betreportformListqqv2";
	private String listurlsec="/lottery/betreportform/betreportformListqqsecv2";
	...
	public String secagreport(HttpServletRequest request, Model model,BetReportform betReportform) 
		...
		if("1".equals(request.getParameter("k"))){
			...
			if(StringUtils.isBlank(requestagentid)){
				...
				model.addAttribute("agentparentid", betagentt.getParentid());
				...
				return "/lottery/betreportform/betreportformagreportsecv2";
			}else{
				...
				model.addAttribute("agentparentid", betaaa.getParentid());
				model.addAttribute(GlobalStatic.returnDatas, returnObject);
				if(!"0000-00-00".equals(starttime)){
					model.addAttribute("startTime", starttime);
				}
...
//						return "/lottery/betreportform/betreportformgameclassbettingList";
	...
	public String list(HttpServletRequest request, Model model,BetReportform betReportform) 
		...
		if("1".equals(request.getParameter("k"))){
			...
			model.addAttribute("date", date);
			model.addAttribute(GlobalStatic.returnDatas, returnObject);
			return "/lottery/betreportform/betreportformbetTransferAccounts";
			...
			page.setOrder("a.id");
			String date = request.getParameter("date");
			BetTransferagentAccounts betTransferagentAccounts = new BetTransferagentAccounts();
			List<BetTransferagentAccounts> datas=new ArrayList<BetTransferagentAccounts>();
			datas=betTransferAccountsService.findListDataByFinder(new Finder("SELECT SUM(a.transferaccountsscore) as transferaccountsscore,a.transferman,a.time,a.agentid from bet_transferagent_accounts a LEFT JOIN bet_agent b on a.transfermanagentid=b.agentid where b.active=1 and (a.agentid=:agentid or a.agentparentids like :aid) and date_format(a.time,:parsetime)=:date GROUP BY a.agentid ").setParam("agentid", agentid).setParam("aid", "%,"+agentid+",%").setParam("parsetime", "%Y-%m-%d").setParam("date",date),page,BetTransferagentAccounts.class,betTransferagentAccounts);
			returnObject.setQueryBean(betTransferagentAccounts);
			returnObject.setPage(page);
			returnObject.setData(datas);
			model.addAttribute("date", date);
			model.addAttribute(GlobalStatic.returnDatas, returnObject);
			return "/lottery/betreportform/betreportformbetTransferAccounts0";
			...
			BetTransferAccounts betTransferAccounts = new BetTransferAccounts();
			List<BetTransferAccounts> datas=new ArrayList<BetTransferAccounts>();
			datas=betTransferAccountsService.findListDataByFinder(new Finder("SELECT SUM(a.transferaccountsscore) as transferaccountsscore,a.transferman,a.time,a.transfermanid from bet_transfer_accounts a LEFT JOIN bet_member b on a.memberid2=b.id2 where b.isinternal=0 and b.isissue=1 and (a.agentid=:agentid or a.agentparentids like :aid) and date_format(a.time,:parsetime)=:date GROUP BY a.transfermanid ").setParam("agentid", agentid).setParam("aid", "%,"+agentid+",%").setParam("parsetime", "%Y-%m-%d").setParam("date",date),page,BetTransferAccounts.class,betTransferAccounts);
			returnObject.setQueryBean(betTransferAccounts);
			returnObject.setPage(page);
			returnObject.setData(datas);
			model.addAttribute("date", date);
			...
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		}else if("126".equals(request.getParameter("k"))){
			//转账分
			ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
			Page page = newPage(request);
			String date = request.getParameter("date");
			...
			BetTransferagentAccounts betTransferagentAccounts = new BetTransferagentAccounts();
			List<BetTransferagentAccounts> datas=new ArrayList<BetTransferagentAccounts>();
			datas=betTransferAccountsService.findListDataByFinder(new Finder("select a.* from bet_transferagent_accounts a LEFT JOIN bet_agent b on a.transfermanagentid=b.agentid where a.agentid=:agentid and b.active=1 and date_format(a.time,:format)=:date ").setParam("agentid", transfermanid).setParam("format", "%Y-%m-%d").setParam("date",date),page,BetTransferagentAccounts.class,betTransferagentAccounts);
			model.addAttribute("transfermanid", transfermanid);
			returnObject.setQueryBean(betTransferagentAccounts);
			returnObject.setPage(page);
			returnObject.setData(datas);
			model.addAttribute("date", date);
			model.addAttribute(GlobalStatic.returnDatas, returnObject);
			return "/lottery/betreportform/betreportformbetTransferagentAccountsList";
			/////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
		}else if("26".equals(request.getParameter("k"))){
			String gcname = request.getParameter("gcname");
			String memberid2 = request.getParameter("memberid2");
			...
			return "/lottery/betreportform/betreportformmemberListgks";
    			...
    			if(today.equals(date)){
    				...
    				return "/lottery/betreportform/gamescorememberList";
    			}else{
    				if("1".equals(order)){
    				...
    				model.addAttribute("date", date);
    				model.addAttribute("order", order);
        			return "/lottery/betreportform/gamescorememberList2";
    			}
				...
				model.addAttribute("show", 0);
				model.addAttribute("agentparentid", betagent.getParentid());
				return "/lottery/betreportform/betreportformListv66";
			}else{
				//本周
				SimpleDateFormat sdfdate = new SimpleDateFormat("yyyy-MM-dd");
				Calendar cal11 = Calendar.getInstance();
	...
	public void listexport(HttpServletRequest request,HttpServletResponse response, Model model,BetAgentreportformJc betAgentreportformJc) throws Exception{
		// ==构造分页请求
		Page page = newPage(request);
		File file = betAgentreportformJcService.findDataExportExcel(null,listurl, page,BetAgentreportformJc.class,betAgentreportformJc);
		String fileName="betAgentreportformJc"+GlobalStatic.excelext;
	...
	ReturnDatas lookjson(Model model,HttpServletRequest request,HttpServletResponse response) throws Exception {
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
		  ...
		  BetAgentreportformJc betAgentreportformJc = betAgentreportformJcService.findBetAgentreportformJcById(id);
		   returnObject.setData(betAgentreportformJc);
		}else{
	...
	public @ResponseBody
	ReturnDatas saveorupdate(Model model,BetAgentreportformJc betAgentreportformJc,HttpServletRequest request,HttpServletResponse response) throws Exception{
		ReturnDatas returnObject = ReturnDatas.getSuccessReturnDatas();
	...
	public String updatepre(Model model,HttpServletRequest request,HttpServletResponse response)  throws Exception{
		ReturnDatas returnObject = lookjson(model, request, response);
		model.addAttribute(GlobalStatic.returnDatas, returnObject);
		return "/lottery/betagentreportformjc/betagentreportformjcCru";
	}
	...
	public @ResponseBody ReturnDatas delete(HttpServletRequest request) throws Exception {
		...
		try {
		  ...
		  if(StringUtils.isNotBlank(strId)){
			 id= java.lang.Integer.valueOf(strId.trim());
				betAgentreportformJcService.deleteById(id,BetAgentreportformJc.class);
	...
	ReturnDatas deleteMore(HttpServletRequest request, Model model) {
		...
		try {
			...
			betAgentreportformJcService.deleteByIds(ids,BetAgentreportformJc.class);
		} catch (Exception e) {
			return new ReturnDatas(ReturnDatas.ERROR,
					MessageUtils.DELETE_ALL_FAIL);
		}
